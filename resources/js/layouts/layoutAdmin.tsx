...
import Sidebar from '@/components/ownComponents/admin/sideBar';
import TopBar from '@/components/ownComponents/admin/topBar';
...
interface LayoutAdminProps {
  ...
  const LayoutAdmin = ({ children, activeTab = '' }: LayoutAdminProps) => {
  const { props } = usePage();
