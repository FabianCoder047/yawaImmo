import {
  ...
  const navItems = [
    { name: 'Dashboard', icon: Home, href: '/proprietaire/dashboard' },
    { name: 'Mes biens', icon: Building2, href: '/proprietaire/mes-biens' },
    { name: 'Abonnements', icon: Wallet, href: '/proprietaire/mes-abonnements' },
    { name: 'Historique', icon: History, href: '/proprietaire/historique' },
  ];
