import {
  ...
  const navItems = [
    ...
    { name: 'Mes biens', icon: Building2, href: '/client/mes-biens' },
    { name: 'Mes recettes', icon: BadgeDollarSign, href: '/client/mes-recettes' },
    { name: 'Mes clients', icon: Users, href: '/client/mes-clients' },
    { name: 'Abonnements', icon: Wallet, href: '/client/mes-abonnements' },
  ];
